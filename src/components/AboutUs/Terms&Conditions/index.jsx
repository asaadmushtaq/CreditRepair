...
function TermsAndConditions() {
    return (
        <div>
            ...
            <div className='container section__padding'>
                <div className='row'>
                    <div className='col-6 col-md-4 mb-5'>
                        ...
                        <p className='text-light text-center cursor mt-3'>
                            {"Affiliate Agreement"}
                        </p>
                    </div>
                    <div className='col-6 col-md-4 mb-5'>
            ...
            <div className='container section__padding pt-0'>
                <h1 className='gradient__subtext text-uppercase'>
                    {"Terms And Conditions"}
                </h1>
                <br />

                <h3 className='gradient__subtext'>
                    {"Customer's Obligations to CreditCiti"}
                </h3>
                ...
                <hr className='gradient__bar' />

                <h3 className='gradient__subtext text-uppercase'>
                    {"CONFIDENTIALITY AND SECURITY OF CLIENT INFORMATION"}
                </h3>
                <p className='text-light font-16 text-justify'>
                    {"We will not, under any circumstances sell or give your information to any third party, PERIOD. Your information is safe with us. "} <br />
                ...
                <p className='text-light font-16 text-justify'>
                    {"We are not responsible for the practices employed by Web sites linked to or from our Web site nor the information or content contained therein. Often links to other Web sites are provided solely as pointers to information on topics that may be useful to the users of our Web site."} <br />
